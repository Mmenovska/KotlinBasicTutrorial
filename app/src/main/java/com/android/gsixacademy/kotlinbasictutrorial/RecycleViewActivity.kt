...
class RecycleViewActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listCars.add (
            Car(
                "Audi",
                "The Audi R8[2] is a mid-engine, 2-seater sports car,[2][3] which uses Audi's trademark quattro permanent all-wheel drive system.[2] It was introduced by the German car manufacturer Audi AG in 2006.",
                R.drawable.audi_r
            )
        )
        listCars.add(
        ...
        listCars.add(
            Car(
                "Jaguar",
                "The Jaguar F-Type (X152) is a two-door, two-seater sports car, manufactured by British luxury car manufacturer Jaguar Land Rover under their Jaguar Cars marque since 2013. \n" + "\n" + "The car was launched initially as a 2-door soft-top convertible, with a 2-door fastback coupé version launched in 2013.",
                R.drawable.jaguar_f
            )
        )
        listCars.add (
        ...
        listCars.add(
            Car(
                "Maserati",
                "The Maserati GranTurismo and GranCabrio (Tipo M145) are a series of a grand tourers produced by the Italian automobile manufacturer Maserati from 2007 to 2019. ... The GranTurismo set a record for the most quickly developed car in the auto industry, going from design to production stage in just nine months.",
        ...
        listCars.add(
            Car(
                "Mercedes",
                "The Mercedes-AMG GT (C190 / R190) is a sports car produced in coupé and roadster bodystyles by German automobile manufacturer Mercedes-AMG. ... After the SLS AMG, it is the second sports car developed entirely in-house by Mercedes-AMG.",
        ...
        for (i in 0..100){
            listCars.add(
                Car(
                    "Nissan",
                    "The Nissan GT-R is a high-performance sports car and grand tourer produced by Nissan, which was unveiled in 2007. It is the successor to the Skyline GT-R, although no longer part of the Skyline range itself, that name now being used for Nissan's luxury-sport market." + i,
                    R.drawable.nissan
                )
            )
        }
